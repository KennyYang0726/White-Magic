...
public class VoiceActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		imageview23.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (FileUtil.isExistFile(
						"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/2-voice/KR_DLC.∠( ᐛ 」∠)＿")) {
					if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
						auto_or_not.setTitle("提示");
						auto_or_not.setIcon(R.drawable.downloadlogo);
						auto_or_not.setMessage("使用自動模式或手動模式？\n自動模式速度較慢，但無須使用MT管理器手動啟用\n手動模式即使用MT管理器按照教學影片進行啟用");
						...
						auto_or_not.setNeutralButton("自動模式", new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface _dialog, int _which) {
								...
								FileUtil.makeDir(
										"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/2-voice/DLC");
								_unzip("/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/2-voice/KR_DLC.∠( ᐛ 」∠)＿",
										"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/2-voice/DLC/");
								showMessage("1 / 3 步驟啟用完成");
								FileUtil.listDir(
										"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/2-voice/DLC/Chinese(Taiwan)/",
