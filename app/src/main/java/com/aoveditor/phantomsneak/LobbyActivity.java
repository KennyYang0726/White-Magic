...
public class LobbyActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
				...
				delete.setPositiveButton("確認", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface _dialog, int _which) {
						if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
							...
							uriB = Uri.parse(
									"content://com.android.externalstorage.documents/tree/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw/document/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw%2Ffiles%2FExtra%2F2019.V2%2FISPDiff%2FLobbyMovie%2F"
											.concat(movie));
							try {
								try {
									DocumentsContract.deleteDocument(getApplicationContext().getContentResolver(),
		...
		button7.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (FileUtil.isExistFile(
						"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/DaoGen1.PS")) {
					_LinkStart("DaoGen1.PS");
				} else {
					DownloadHttpUrlConnection("https://" + daogen1,
							"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/", "DaoGen1.PS");
		...
		button8.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (FileUtil.isExistFile(
						"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/DaoGen2.PS")) {
					_LinkStart("DaoGen2.PS");
				} else {
					DownloadHttpUrlConnection("https://" + daogen2,
							"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/", "DaoGen2.PS");
					showMessage("下載完成再次點擊以啟用");
				}
			}
		...
		button9.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (FileUtil.isExistFile(
						"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/Nakaroth.PS")) {
					_LinkStart("Nakaroth.PS");
				} else {
					DownloadHttpUrlConnection("https://" + Nak3,
							"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/",
							"Nakaroth.PS");
					showMessage("下載完成再次點擊以啟用");
				}
			}
		...
		button10.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (FileUtil.isExistFile(
						"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/WAVE.PS")) {
					_LinkStart("WAVE.PS");
				} else {
					DownloadHttpUrlConnection("https://" + WAVE4,
							"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/", "WAVE.PS");
					showMessage("下載完成再次點擊以啟用");
				}
			}
		...
		button11.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (FileUtil.isExistFile(
						"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/newyear2021.PS")) {
					_LinkStart("newyear2021.PS");
				} else {
					DownloadHttpUrlConnection("https://" + NY_2021_5,
							"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/",
							"newyear2021.PS");
					showMessage("下載完成再次點擊以啟用");
				}
		...
		button12.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (FileUtil.isExistFile(
						"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/newyear2022.PS")) {
					_LinkStart("newyear2022.PS");
				} else {
					DownloadHttpUrlConnection("https://" + NY_2022_6,
							"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/",
							"newyear2022.PS");
					showMessage("下載完成再次點擊以啟用");
				}
		...
		button13.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (FileUtil.isExistFile(
						"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/Ultraman.PS")) {
					_LinkStart("Ultraman.PS");
				} else {
					DownloadHttpUrlConnection("https://" + AutoMan7,
							"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/",
							"Ultraman.PS");
					showMessage("下載完成再次點擊以啟用");
				}
		...
		button14.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (FileUtil.isExistFile(
						"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/poolparty.PS")) {
					_LinkStart("poolparty.PS");
				} else {
					DownloadHttpUrlConnection("https://" + PoolParty8,
							"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/",
							"poolparty.PS");
					showMessage("下載完成再次點擊以啟用");
				}
		...
		button15.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (FileUtil.isExistFile(
						"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/AIC2020.PS")) {
					_LinkStart("AIC2020.PS");
				} else {
					DownloadHttpUrlConnection("https://" + AIC_2020_9,
							"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/", "AIC2020.PS");
					showMessage("下載完成再次點擊以啟用");
				}
			}
		...
		button16.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (FileUtil.isExistFile(
						"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/KaLunNuo.PS")) {
					_LinkStart("KaLunNuo.PS");
				} else {
					DownloadHttpUrlConnection("https://" + KaRenNo_10,
							"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/",
							"KaLunNuo.PS");
					showMessage("下載完成再次點擊以啟用");
				}
		...
		button18.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (anime1.contains("敬請期待")) {
					...
					if (FileUtil
							.isExistFile("/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/"
									+ anime1 + ".PS")) {
						_LinkStart(anime1 + ".PS");
					} else {
						DownloadHttpUrlConnection("https://" + anime1_url,
								"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/",
								anime1 + ".PS");
						showMessage("下載完成再次點擊以啟用");
					}
			...
			public void onClick(View _view) {
				if (anime2.contains("敬請期待")) {
					...
					if (FileUtil
						...
						DownloadHttpUrlConnection("https://" + anime2_url,
								"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/",
								anime2 + ".PS");
						showMessage("下載完成再次點擊以啟用");
					}
			...
			public void onClick(View _view) {
				if (anime3.contains("敬請期待")) {
					...
					if (FileUtil
						...
						DownloadHttpUrlConnection("https://" + anime3_url,
								"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/",
								anime3 + ".PS");
						showMessage("下載完成再次點擊以啟用");
					}
	...
	private void initializeLogic() {
		...
		LinearLayout.LayoutParams p3 = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,
	...
	public void _LinkStart(final String _fileName) {
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
			...
			_unzip("/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/".concat(_fileName),
					"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/tmp/");
						...
						public void run() {
							...
							try {
								...
								uri2 = Uri.parse(
										"content://com.android.externalstorage.documents/tree/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw/document/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw%2Ffiles%2FExtra%2F2019.V2%2FSound_DLC%2FAndroid%2F");
								_copyFilePath2Uri(
										"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/tmp/Sound_DLC/Android/"
												.concat(sound));
							} catch (Exception e) {
							...
							try {
								...
								uri2 = Uri.parse(
										"content://com.android.externalstorage.documents/tree/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw/document/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw%2Ffiles%2FExtra%2F2019.V2%2FISPDiff%2FLobbyMovie%2F");
								_copyFilePath2Uri(
										"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/tmp/ISPDiff/LobbyMovie/"
												.concat(movie));
								showMessage("啟用成功");
								FileUtil.deleteFile(
										"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/tmp");
			...
			_unzip("/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/3-lobby/".concat(_fileName),
					"/storage/emulated/0/Android/data/com.garena.game.kgtw/files/Extra/2019.V2/");
			showMessage("完成");
		}
	}
