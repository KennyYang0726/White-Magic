...
public class SkinActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button3.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (FileUtil.isExistFile("/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/1-skin/"
						.concat(skin_name))) {
					...
					if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
						...
						_unzip("/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/1-skin/".concat(
								skin_name), "/storage/emulated/0/Android/data/com.garena.game.kgtw/files/Resources/");
						showMessage("完成");
					}
				} else {
					...
					Download("https://" + desurl,
							"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/1-skin/");
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				skin_plugin.addListenerForSingleValueEvent(new ValueEventListener() {
					...
					public void onDataChange(DataSnapshot _dataSnapshot) {
						...
						Desceiption();
						if (FileUtil
								.isExistFile("/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/1-skin/"
										.concat(skin_name))) {
							button3.setText("啟用");
						} else {
							button3.setText("下載插件");
	...
	private void initializeLogic() {
		...
		LinearLayout.LayoutParams p1 = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,
	...
	public void _startSkin() {
		...
		_unzip("/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/1-skin/".concat(skin_name),
				"/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/1-skin/tmp/");
		uriA = Uri.parse(
				"content://com.android.externalstorage.documents/tree/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw/document/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw%2Ffiles%2FResources%2F"
						+ game_ver + "%2FDatabin%2FClient%2FActor%2F" + "heroSkin.bytes");
		try {
			try {
			...
			uri2 = Uri.parse(
					"content://com.android.externalstorage.documents/tree/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw/document/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw%2Ffiles%2FResources%2F"
							+ game_ver + "%2FDatabin%2FClient%2FActor%2F");
			_copyFilePath2Uri("/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/1-skin/tmp/" + game_ver
		...
		uriB = Uri.parse(
				"content://com.android.externalstorage.documents/tree/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw/document/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw%2Ffiles%2FResources%2F"
						+ game_ver + "%2FDatabin%2FClient%2FCharacter%2F" + "ResCharacterComponent.bytes");
		try {
			try {
			...
			uri2 = Uri.parse(
					"content://com.android.externalstorage.documents/tree/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw/document/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw%2Ffiles%2FResources%2F"
							+ game_ver + "%2FDatabin%2FClient%2FCharacter%2F");
			_copyFilePath2Uri("/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/1-skin/tmp/" + game_ver
		...
		uriB = Uri.parse(
				"content://com.android.externalstorage.documents/tree/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw/document/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw%2Ffiles%2FResources%2F"
						+ game_ver + "%2FDatabin%2FClient%2FCharacter%2F" + "ResComponentShow.bytes");
		try {
			try {
				DocumentsContract.deleteDocument(getApplicationContext().getContentResolver(), uriB);
			} catch (FileNotFoundException e) {
			...
			uri2 = Uri.parse(
					"content://com.android.externalstorage.documents/tree/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw/document/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw%2Ffiles%2FResources%2F"
							+ game_ver + "%2FDatabin%2FClient%2FCharacter%2F");
			_copyFilePath2Uri("/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/1-skin/tmp/" + game_ver
					+ "/Databin/Client/Character/ResComponentShow.bytes");
		} catch (Exception e) {

		}
		uriC = Uri.parse(
				"content://com.android.externalstorage.documents/tree/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw/document/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw%2Ffiles%2FResources%2F"
						+ game_ver + "%2FDatabin%2FClient%2FSkill%2F" + "liteBulletCfg.bytes");
		try {
			try {
			...
			uri2 = Uri.parse(
					"content://com.android.externalstorage.documents/tree/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw/document/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw%2Ffiles%2FResources%2F"
							+ game_ver + "%2FDatabin%2FClient%2FSkill%2F");
			_copyFilePath2Uri("/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/1-skin/tmp/" + game_ver
		...
		uriC = Uri.parse(
				"content://com.android.externalstorage.documents/tree/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw/document/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw%2Ffiles%2FResources%2F"
						+ game_ver + "%2FDatabin%2FClient%2FSkill%2F" + "skillmark.bytes");
		try {
			try {
				DocumentsContract.deleteDocument(getApplicationContext().getContentResolver(), uriC);
			} catch (FileNotFoundException e) {
		...
		uriD = Uri.parse(
				"content://com.android.externalstorage.documents/tree/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw/document/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw%2Ffiles%2FResources%2F"
						+ game_ver + "%2FDatabin%2FClient%2FSound%2F" + "BattleBank.bytes");
		try {
			try {
			...
			uri2 = Uri.parse(
					"content://com.android.externalstorage.documents/tree/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw/document/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw%2Ffiles%2FResources%2F"
							+ game_ver + "%2FDatabin%2FClient%2FSound%2F");
			_copyFilePath2Uri("/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/1-skin/tmp/" + game_ver
		...
		uriD = Uri.parse(
				"content://com.android.externalstorage.documents/tree/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw/document/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw%2Ffiles%2FResources%2F"
						+ game_ver + "%2FDatabin%2FClient%2FSound%2F" + "ChatSound.bytes");
		try {
			try {
				DocumentsContract.deleteDocument(getApplicationContext().getContentResolver(), uriD);
			} catch (FileNotFoundException e) {
		...
		uriD = Uri.parse(
				"content://com.android.externalstorage.documents/tree/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw/document/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw%2Ffiles%2FResources%2F"
						+ game_ver + "%2FDatabin%2FClient%2FSound%2F" + "HeroSound.bytes");
		try {
			try {
				DocumentsContract.deleteDocument(getApplicationContext().getContentResolver(), uriD);
			} catch (FileNotFoundException e) {
		...
		uriD = Uri.parse(
				"content://com.android.externalstorage.documents/tree/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw/document/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw%2Ffiles%2FResources%2F"
						+ game_ver + "%2FDatabin%2FClient%2FSound%2F" + "LobbyBank.bytes");
		try {
			try {
				DocumentsContract.deleteDocument(getApplicationContext().getContentResolver(), uriD);
			} catch (FileNotFoundException e) {
		...
		uriD = Uri.parse(
				"content://com.android.externalstorage.documents/tree/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw/document/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw%2Ffiles%2FResources%2F"
						+ game_ver + "%2FDatabin%2FClient%2FSound%2F" + "LobbySound.bytes");
		try {
			try {
				DocumentsContract.deleteDocument(getApplicationContext().getContentResolver(), uriD);
			} catch (FileNotFoundException e) {
		...
		FileUtil.listDir("/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/1-skin/tmp/" + game_ver
				+ "/Ages/Prefab_Characters/Prefab_Hero/", file_list);
			...
			public void run() {
				for (int j = 0; j < (int) (file_list.size()); j++) {
					try {
						uriA = Uri.parse(
								"content://com.android.externalstorage.documents/tree/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw/document/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw%2Ffiles%2FResources%2F"
										+ game_ver + "%2FAges%2FPrefab_Characters%2FPrefab_Hero%2F"
										+ Uri.parse(file_list.get((count - 1))).getLastPathSegment());
						try {
							DocumentsContract.deleteDocument(getApplicationContext().getContentResolver(), uriA);
						} catch (FileNotFoundException e) {
					...
					uri2 = Uri.parse(
							"content://com.android.externalstorage.documents/tree/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw/document/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw%2Ffiles%2FResources%2F"
									+ game_ver + "%2FAges%2FPrefab_Characters%2FPrefab_Hero%2F");
					_copyFilePath2Uri("/storage/emulated/0/Android/data/com.aoveditor.phantomsneak/files/1-skin/tmp/"
							+ game_ver + "/Ages/Prefab_Characters/Prefab_Hero/"
							+ Uri.parse(file_list.get(count - 1)).getLastPathSegment());
					count--;
					runOnUiThread(new Runnable() {
						@Override
									...
									public void run() {
										for (int k = 0; k < (int) (file_list.size()); k++) {
											try {
												uriA = Uri.parse(
														"content://com.android.externalstorage.documents/tree/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw/document/primary%3AAndroid%2Fdata%2Fcom.garena.game.kgtw%2Ffiles%2FResources%2F"
																+ game_ver + "%2FAssetRefs%2FHero%2F"
																+ Uri.parse(file_list.get((count - 1)))
																		.getLastPathSegment());
												try {
	...
	public void _loadInerstitialAd() {
		...
		InterstitialAd.load(SkinActivity.this, "ca-app-pub-3897977034034314/2804897827", inreq,
