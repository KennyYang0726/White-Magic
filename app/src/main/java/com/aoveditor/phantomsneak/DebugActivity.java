...
public class DebugActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String finalErrorMessage = madeErrorMessage;
        AlertDialog dialog = new AlertDialog.Builder(this)
                .setTitle("嗶嗶嗶錯誤啦～ (*_*)")
                .setMessage(madeErrorMessage)
                .setPositiveButton("複製錯誤並離開", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        ((ClipboardManager) getSystemService(getApplicationContext().CLIPBOARD_SERVICE)).setPrimaryClip(ClipData.newPlainText("clipboard", finalErrorMessage));
